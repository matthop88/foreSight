...
return {
    ...
    startLeft  = function(self) self.xSpeed =  self.scrollSpeed end,
    startRight = function(self) self.xSpeed = -self.scrollSpeed end,
    startUp    = function(self) self.ySpeed =  self.scrollSpeed end,
    startDown  = function(self) self.ySpeed = -self.scrollSpeed end,
    ...
    isMotionless = function(self)
        return self.xSpeed == 0 and self.ySpeed == 0
    end,
}
