...
return {
	w = require("app/plugins/libraries/tweenableValue"):create(40,   { speed = 6 }),
	h = require("app/plugins/libraries/tweenableValue"):create(40,   { speed = 6 }),
		
	opened = false,

	init = function(self, params)
		self.origX = params.x or 800
		self.x = require("app/plugins/libraries/tweenableValue"):create(self.origX, { speed = 6 })
